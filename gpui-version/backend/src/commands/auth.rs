use crate::crypto::KDF_VERSION_LATEST;
use crate::dpapi;
...
pub fn verify_master_password(
    ...
    // 验证成功后，若使用旧版密钥派生或旧版加密算法则自动迁移到最新版（Argon2id + GCM）
    if verified && (s.key_derivation_version < KDF_VERSION_LATEST || s.encryption_version == 0) {
